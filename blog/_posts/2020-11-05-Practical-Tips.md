...
![Folder Structure]({{ site.url }}{{ site.baseurl }}/assets/originals/Practical_tips/Folder_Structure_Example.png)
...
![File Naming Convention]({{ site.url }}{{ site.baseurl }}/assets/originals/Practical_tips/Naming_Convention_Example.png)
...
![3-2-1 Diagram]({{ site.url }}{{ site.baseurl }}/assets/originals/Practical_tips/Diagram-1440x1018.png)
