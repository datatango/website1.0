...
![House electrical layout]({{ site.url }}{{ site.baseurl }}/assets/originals/Network_I/electrical_plan_v2.png)

## The hardware diagram and breakdown

![Network diagram]({{ site.url }}{{ site.baseurl }}/assets/originals/Network_I/Network_diagram.jpg)
