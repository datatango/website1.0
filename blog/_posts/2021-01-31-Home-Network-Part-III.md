...
![opennet setup]({{ site.url }}{{ site.baseurl }}/assets/originals/Network_II/open_net_1.jpg)

![opennet setup]({{ site.url }}{{ site.baseurl }}/assets/originals/Network_II/open_net_2.jpg)

![opennet setup]({{ site.url }}{{ site.baseurl }}/assets/originals/Network_II/open_net_3.jpg)

![opennet setup]({{ site.url }}{{ site.baseurl }}/assets/originals/Network_II/open_net_4.jpg)
